...
//   return (
//     <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-blue-100 overflow-hidden">
...
//           Every picture reflects hope, compassion, and the lives we touch.
//         </p>
//       </div>

//       <div className="relative h-[320px] max-w-7xl mx-auto px-6 overflow-hidden">
//         <div className="relative w-full h-full flex items-center justify-center perspective-[2000px]">
//           {images.map((image, index) => (
//             <div
//               key={index}
//               style={getCardStyle(index)}
//               className="absolute w-[220px] h-[280px] rounded-3xl overflow-hidden shadow-2xl transition-all duration-700 ease-in-out"
//             >
//               <img
//                 src={image}
//                 alt={`Gallery ${index + 1}`}
