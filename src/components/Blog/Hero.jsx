  ...
  return (
    <section className="py-16 md:py-20 bg-gradient-to-b from-white to-yellow-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
        ...
        >
          Our
          <span className="text-[#C89A31]"> Blog</span>
        </motion.h1>
        ...
        >
          Discover inspiring stories, impactful initiatives, and the latest
          updates from our mission to empower communities and create lasting
          positive change.
        </motion.p>
      </div>
    </section>
