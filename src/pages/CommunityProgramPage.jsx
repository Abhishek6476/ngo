...
const features = [
  {
    ...
    description:
      "Bringing people together through inclusive programs, local initiatives, and collaborative action.",
  },
  {
    icon: FaHome,
    title: "Safe Spaces",
    description:
      "Creating welcoming environments where families can connect, learn, and thrive together.",
  },
  {
    icon: FaHandsHelping,
    title: "Volunteer Support",
    description:
      "Mobilizing passionate volunteers to serve, mentor, and uplift communities in need.",
  },
  {
    icon: FaGlobe,
    title: "Sustainable Growth",
    description:
      "Developing long-term solutions that strengthen neighborhoods and foster resilience.",
  },
];

const stats = [
  { number: "25,000+", label: "Lives Impacted" },
  { number: "300+", label: "Community Events" },
  { number: "150+", label: "Volunteers" },
  { number: "40+", label: "Communities Served" },
];
...
const CommunityProgramPage = () => {
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                Empowering communities through collaboration, support, and
                sustainable initiatives that create lasting positive change.
              </motion.p>
            ...
            >
              ...
              <div className="absolute -bottom-8 left-8 bg-white rounded-3xl shadow-2xl p-6 border border-yellow-100">
                <h4 className="text-3xl font-bold text-gray-900">25,000+</h4>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
    ...
    >
      ...
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-5">
        Creating Stronger
        <span className="block text-[#C89A31]">Communities</span>
      </h2>

      <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-8">
        Strong communities are built on trust, compassion, and collective
        action. Together, we create opportunities and lasting impact.
      </p>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
    ...
    <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
      ...
      <p className="mt-4 sm:mt-5 text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed px-2">
        Strengthening neighborhoods through impactful initiatives.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 sm:gap-8">
      {features.map((feature, index) => (
        <motion.div
          ...
          whileHover={{ y: -12 }}
          transition={{ duration: 0.4 }}
          className="group relative bg-white rounded-3xl p-6 sm:p-8 border border-yellow-100 shadow-md hover:shadow-2xl hover:border-[#C89A31]/30 transition-all duration-500 overflow-hidden"
        >
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
      {stats.map((stat, index) => (
        <div
          key={index}
          className="text-center bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg border border-yellow-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300"
        >
          <h3 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#C89A31] mb-3">
            {stat.number}
          </h3>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
    ...
    <div className="text-center mb-12 sm:mb-14">
      ...
      <p className="mt-4 text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed px-2">
        Celebrating collaboration, compassion, and community impact.
      </p>
    </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#C89A31] to-[#D9A93A] text-center py-6 md:py-7 px-6 text-white shadow-xl">
            ...
            <div className="relative z-10">
              <h2 className="text-2xl md:text-4xl font-semibold mb-2">
                Build Stronger
                <span className="italic text-yellow-100"> Communities</span>
              </h2>

              <p className="max-w-2xl mx-auto text-white/90 mb-4 leading-relaxed text-sm md:text-base">
                Your support helps us create resilient, inclusive, and thriving
