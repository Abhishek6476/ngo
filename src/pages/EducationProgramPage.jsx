...
const features = [
  {
    ...
    description:
      "Providing free educational resources, books, and classroom support to underprivileged children.",
  },
  {
    icon: FaUserGraduate,
    title: "Expert Mentorship",
    description:
      "Connecting students with mentors who guide and inspire their academic journey.",
  },
  {
    icon: FaLaptopCode,
    title: "Digital Literacy",
    description:
      "Equipping young minds with essential computer and technology skills.",
  },
  {
    icon: FaHandsHelping,
    title: "Community Support",
    description:
      "Creating safe, inclusive, and inspiring learning environments.",
  },
];

const stats = [
  { number: "5,000+", label: "Students Supported" },
  { number: "120+", label: "Schools Connected" },
...
const EducationProgramPage = () => {
  return (
    <div className="bg-gradient-to-b from-white via-[#fffdf7] to-yellow-50 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
              ...
              >
                Empowering Children
                <span className="block text-[#C89A31]">Through Education</span>
              </motion.h1>
              ...
              >
                Providing quality education, mentorship, and digital literacy to
                children from underserved communities, helping them build
                brighter futures.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 xl:gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 text-sm sm:text-base md:text-lg leading-relaxed mb-6">
              Education opens doors to opportunity, confidence, and success. Our
              initiative ensures every child receives quality learning,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-14 md:mb-16">
            ...
            <p className="mt-4 sm:mt-5 text-gray-600 text-sm sm:text-base md:text-lg leading-relaxed">
              Transforming lives through impactful educational initiatives.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          ...
          <div className="text-center mb-10 sm:mb-12 md:mb-14">
            ...
            <p className="mt-3 sm:mt-4 text-gray-600 text-sm sm:text-base md:text-lg max-w-2xl mx-auto">
              Capturing inspiring moments of learning, growth, and
              transformation.
            </p>
          </div>
      ...
      {/* CTA */}
      <section className="bg-gradient-to-b from-yellow-50 to-white py-6 sm:py-7 md:py-8 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#C89A31] to-[#D9A93A] text-center py-5 sm:py-6 md:py-7 px-4 sm:px-6 text-white shadow-xl">
            {/* Background Effects */}
            <div className="absolute -top-14 -left-14 w-32 sm:w-36 md:w-40 h-32 sm:h-36 md:h-40 bg-white/10 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-14 -right-14 w-32 sm:w-36 md:w-40 h-32 sm:h-36 md:h-40 bg-white/10 rounded-full blur-3xl"></div>

            <div className="relative z-10">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mb-2 leading-tight">
                Help Build{" "}
                <span className="italic text-yellow-100">Brighter Futures</span>
              </h2>

              <p className="max-w-2xl mx-auto text-white/90 mb-4 leading-relaxed text-xs sm:text-sm md:text-base px-2">
                Your support empowers children with education, mentorship, and
                opportunities for a brighter tomorrow.
              </p>

              <Link
                to="/donate"
                className="inline-flex items-center gap-2 sm:gap-3 px-5 sm:px-6 py-2 sm:py-2.5 bg-white text-[#C89A31] font-semibold rounded-lg hover:scale-105 transition duration-300 shadow-lg text-sm sm:text-base"
              >
                Donate Now
                <FaArrowRight className="text-xs sm:text-sm" />
              </Link>

              <div className="flex justify-center gap-2 sm:gap-3 mt-4 sm:mt-5 flex-wrap">
                {[BsInstagram, FaWhatsapp, FaFacebookF, BsTwitterX].map(
                  (Icon, index) => (
                    <button
                      key={index}
                      className="w-8 sm:w-9 h-8 sm:h-9 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white hover:bg-white hover:text-[#C89A31] transition duration-300"
                    >
