...
const features = [
  {
    ...
    description:
      "Providing immediate emergency assistance during natural disasters, accidents, and humanitarian crises.",
  },
  {
    icon: FaHandsHelping,
    title: "Relief Distribution",
    description:
      "Delivering food, water, medicines, and essential supplies to affected families quickly and efficiently.",
  },
  {
    icon: FaShieldAlt,
    title: "Safety & Protection",
    description:
      "Ensuring the safety, shelter, and well-being of vulnerable communities during emergencies.",
  },
  {
    icon: FaGlobeAsia,
    title: "Disaster Recovery",
    description:
      "Helping communities rebuild stronger through rehabilitation, support, and long-term recovery programs.",
  },
];

const stats = [
  { number: "15,000+", label: "Lives Assisted" },
  { number: "120+", label: "Relief Camps" },
  { number: "300+", label: "Volunteers" },
  { number: "25+", label: "Disaster Zones" },
];
...
const EmergencyDisasterSupportPage = () => {
  return (
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              >
                Delivering urgent relief, rescue, and recovery support to
                communities affected by disasters, emergencies, and crises.
              </motion.p>
            ...
            >
              ...
              <div className="absolute -bottom-8 left-8 bg-white rounded-3xl shadow-2xl p-6 border border-yellow-100">
                <h4 className="text-3xl font-bold text-gray-900">15,000+</h4>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
    ...
    >
      ...
      <p className="text-base sm:text-lg text-gray-600 leading-relaxed mb-8">
        During emergencies, immediate action can save lives. Our dedicated
        teams provide rapid relief, essential resources, and hope when it
        is needed most.
      </p>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
    ...
    <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
      ...
      <p className="mt-4 sm:mt-5 text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed px-2">
        Providing immediate, compassionate, and effective disaster relief.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 sm:gap-8">
      {features.map((feature, index) => (
        <motion.div
          ...
          whileHover={{ y: -12 }}
          transition={{ duration: 0.4 }}
          className="group relative bg-white rounded-3xl p-6 sm:p-8 border border-yellow-100 shadow-md hover:shadow-2xl hover:border-[#C89A31]/30 hover:-translate-y-3 transition-all duration-500 overflow-hidden"
        >
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
      {stats.map((stat, index) => (
        <motion.div
          ...
          className="group relative text-center bg-white rounded-3xl p-6 sm:p-8 shadow-lg border border-yellow-100 hover:shadow-2xl hover:border-[#C89A31]/30 transition-all duration-500 overflow-hidden"
        >
          {/* Hover Background */}
          ...
          <div className="absolute top-0 left-0 h-1 w-full bg-[#C89A31] scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500" />
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
    ...
    <div className="text-center mb-10 sm:mb-12 md:mb-14">
      ...
      <p className="mt-3 sm:mt-4 text-gray-600 text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
        Witnessing resilience, compassion, and recovery in action.
      </p>
    </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#C89A31] to-[#D9A93A] text-center py-6 md:py-7 px-6 text-white shadow-xl">
            ...
            <div className="relative z-10">
              ...
              <p className="max-w-2xl mx-auto text-white/90 mb-4 leading-relaxed text-sm md:text-base">
                Your support enables rapid response, relief distribution, and
                recovery for families affected by emergencies and disasters.
              </p>
...
export default EmergencyDisasterSupportPage;